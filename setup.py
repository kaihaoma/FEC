...
def main(argv: List[str]) -> None:
    ...
    if "clean" in unknown:
        ...
        out = check_output(
            [sys.executable, "setup.py", "clean"], cwd="third_party/fbgemm/fbgemm_gpu",
        )
        print(out)
    # install/build
    else:
        if args.skip_fbgemm:
            ...
            print("fbgemm_kw_args: ", fbgemm_kw_args)
            print("env: ", my_env)
            out = check_output(
    ...
    print("install_requires: ", reqs)
    print("package_dir: ", fbgemm_gpu_package_dir)
    ...
    setup(
        ...
        packages=packages,
        package_dir={"torchrec": "torchrec", "fbgemm_gpu": fbgemm_gpu_package_dir,},
        zip_safe=False,
